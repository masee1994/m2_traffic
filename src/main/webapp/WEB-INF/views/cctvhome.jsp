...
@font-face {
  font-family:'maple';
  src: url('resources/css/AppleSDGothicNeoB.ttf') format('truetype');
}
</style>
...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item active" style="font-family: maple;"><a class="nav-link"
				href="cctvhome"> <i class="fa-solid fa-video"></i> <span>CCTV
				</span></a></li>
			<li class="nav-item active" style="font-family: maple;"><a class="nav-link"
				href="index.html"> <i class="fa-solid fa-chart-simple"></i> <span>통계
				</span></a></li>
						...
						<div class="col-xl-8 col-lg-7" style="margin-top: 20px; font-family: maple; font-size: 16px;">
							<div class="card shadow mb-4">
								...
								<div
									...
									<jsp:include page="cctvtest.jsp" flush="false" />
